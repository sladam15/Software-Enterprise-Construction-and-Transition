public class BattleScenario {
    ...
    Mascotmon mon2;
    Stats mon1Stats;
    // Stats mon2Stats;  //SER316 TASK 2 SPOTBUGS FIX
    ...
    /**
     * Method starts battle between two monsters and displays the appropriate results of
     * who is fighting and announcing who has won.
     *
     */
    public void initiateBattle() {
        ...
        // mon2Stats = new Stats(mon2.name);      //SER316 TASK 2 SPOTBUGS FIX
     ...
     * or debuffed based on the weather.
     * EG. fire monsters have a stat advantage of +25% in sunny weather
     * while they have a stat disadvantage of -25% in the rain.
     * If the attack chosen, matches the monsters type,
     * the attacker will get an extra 20% on its attack.
     ...
     *
     * @param pAttack   is the attack value given to the method where that
     *                  attack value is based on the monsters damage value
    ...
    public double calculateDamage(Attack pAttack, Mascotmon pAttacker, Mascotmon pDefender) {
        ...
        // weather bonuses
        if (this.battleWeather.getBuffedType().equals(pAttacker.type)) {   //SER316 TASK 2 SPOTBUGS FIX
        ...
        if (this.battleWeather.getBuffedType().equals(pDefender.type)) {    //SER316 TASK 2 SPOTBUGS FIX
